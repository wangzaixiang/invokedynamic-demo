...
public class TestInvokeDynamicConstantCallSiteDump implements Opcodes {

	public static void main(String[] args) throws Exception {
		
		String dir = "gen";
		String path = "demo/invoke/TestInvokeDynamicConstantCallSite.class";
		byte[] clazz = dump();
	...
	public static byte[] dump() throws Exception {
		...
		cw.visit(V1_7, ACC_PUBLIC + ACC_SUPER,
				"demo/invoke/TestInvokeDynamicConstantCallSite", null,
...
//					"(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;");
			...
			mv.visitInvokeDynamicInsn("replace", "(Ljava/lang/String;CC)Ljava/lang/String;", constantBSM, 
...
//					"(CC)Ljava/lang/String;");
			...
			mv.visitInsn(DUP);
			mv.visitLdcInsn("TestInvokeDynamic with constant callsite Total time is ");
